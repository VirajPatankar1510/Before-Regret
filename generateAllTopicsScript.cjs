...
const topics = [
  ...
  // 11. Lift Waiting Times
  {
    ...
    backgroundFields: [
      { id: 'residentType', label: 'Resident Type', inputType: 'radio', options: ['Owner', 'Tenant'], defaultValue: 'Owner' },
      { id: 'floorRange', label: 'Floor Level', inputType: 'select', options: ['Floor 1 - 10', 'Floor 11 - 20', 'Floor 21 - 30', 'Floor 31+'], defaultValue: 'Floor 11 - 20' }
    ],
    generateRelevantExperience: (bg) => `${bg.residentType || 'Owner'} on ${(bg.floorRange || 'Floor 11-20').toLowerCase()} experiencing daily morning elevator rush.`,
    followUpQuestions: [
      {
        id: 'lw_mq_1',
      ...
      },
      {
        ...
        inputType: 'rating',
        options: makeRatingOptions('Elevator Waiting Time & Lift Speed')
      }
    ]
  },
  ...
  // 12. Lift Breakdown Speed
  {
    ...
    generateRelevantExperience: (bg) => `${bg.yearsLiving || '3-5 years'} ${(bg.residentType || 'Owner').toLowerCase()} monitoring elevator maintenance and repairs.`,
    followUpQuestions: [
      {
        id: 'lb_mq_1',
      ...
      },
      {
        ...
        inputType: 'rating',
        options: makeRatingOptions('Elevator Reliability & Repair Turnaround Speed')
      }
    ]
  },
  ...
  // 13. Quick Commerce & Deliveries
  {
    ...
    generateRelevantExperience: (bg) => `${bg.yearsLiving || '3-5 years'} ${(bg.residentType || 'Owner').toLowerCase()} ordering quick commerce groceries and food deliveries daily.`,
    followUpQuestions: [
      {
        id: 'dd_mq_1',
      ...
      },
      {
        ...
        inputType: 'rating',
        options: makeRatingOptions('Doorstep Delivery Speed & Cab Convenience')
      }
    ]
  },
  ...
  // 14. Maid Availability
  {
    ...
    backgroundFields: [
      { id: 'residentType', label: 'Resident Type', inputType: 'radio', options: ['Owner', 'Tenant'], defaultValue: 'Owner' },
      { id: 'maidSetup', label: 'Domestic Help Setup', inputType: 'select', options: ['Maid & Cook', 'Maid Only', 'Car Washer Only', 'Self-Managed'], defaultValue: 'Maid & Cook' }
    ],
    generateRelevantExperience: (bg) => `Resident employing ${(bg.maidSetup || 'Maid & Cook').toLowerCase()} managing domestic support staff.`,
    followUpQuestions: [
      {
        id: 'ma_mq_1',
      ...
      },
      {
        ...
        inputType: 'rating',
        options: makeRatingOptions('Domestic Help Availability & Salary Fairness')
      }
    ]
  },
  ...
  // 15. Monsoon Gate Flooding
  {
    ...
    backgroundFields: [
      { id: 'residentType', label: 'Resident Type', inputType: 'radio', options: ['Owner', 'Tenant'], defaultValue: 'Owner' },
      { id: 'yearsLiving', label: 'Tenure of Stay', inputType: 'select', options: ['Less than 1 year', '1 - 3 years', '3 - 5 years', '5+ years'], defaultValue: '5+ years' }
    ],
    generateRelevantExperience: (bg) => `${bg.yearsLiving || '5+ years'} ${(bg.residentType || 'Owner').toLowerCase()} who experienced multiple heavy monsoons in society.`,
    followUpQuestions: [
      {
        id: 'mg_mq_1',
      ...
      },
      {
        ...
        inputType: 'rating',
        options: makeRatingOptions('Monsoon Gate Flooding & Road Resilience')
      }
    ]
  },
  ...
  // 16. Monsoon Seepage
  {
    ...
    backgroundFields: [
      { id: 'residentType', label: 'Resident Type', inputType: 'radio', options: ['Owner', 'Tenant'], defaultValue: 'Owner' },
      { id: 'basementLevel', label: 'Basement Level', inputType: 'select', options: ['Basement 1 (B1)', 'Basement 2 (B2)', 'Basement 3 (B3)', 'Ground / Podium'], defaultValue: 'Basement 2 (B2)' }
    ],
    generateRelevantExperience: (bg) => `Resident parking in ${(bg.basementLevel || 'B2 Basement').toLowerCase()} observing building monsoon waterproofing.`,
    followUpQuestions: [
      {
        id: 'ms_mq_1',
      ...
      },
      {
        ...
        inputType: 'rating',
        options: makeRatingOptions('Monsoon Waterproofing & Seepage Protection')
      }
    ]
  },
  ...
  // 17. Committee Fairness
  {
    ...
    generateRelevantExperience: (bg) => `${bg.yearsLiving || '3-5 years'} ${(bg.residentType || 'Owner').toLowerCase()} interacting with society managing committee.`,
    followUpQuestions: [
      {
        id: 'cf_mq_1',
      ...
      },
      {
        ...
        inputType: 'rating',
        options: makeRatingOptions('Managing Committee Fairness & Governance')
      }
    ]
  },
  ...
  // 18. Renovation & Move-In NOC
  {
    ...
    generateRelevantExperience: (bg) => `${(bg.residentType || 'Owner').toLowerCase()} who went through society NOC and shifting approvals.`,
    followUpQuestions: [
      {
        id: 'rm_mq_1',
      ...
      },
      {
        ...
        inputType: 'rating',
        options: makeRatingOptions('Renovation NOC & Move-In Process Ease')
      }
    ]
  },
  ...
  // 19. Hidden Costs & Hikes
  {
    ...
    generateRelevantExperience: (bg) => `${(bg.residentType || 'Owner').toLowerCase()} paying monthly society maintenance and amenity dues.`,
    followUpQuestions: [
      {
        id: 'hc_mq_1',
      ...
      },
      {
        ...
        inputType: 'rating',
        options: makeRatingOptions('Fee Transparency & Financial Predictability')
      }
    ]
  },
  ...
  // 20. Child Safety & Play Area
  {
    ...
    backgroundFields: [
      { id: 'residentType', label: 'Resident Type', inputType: 'radio', options: ['Owner', 'Tenant'], defaultValue: 'Owner' },
      { id: 'familyProfile', label: 'Family Profile', inputType: 'select', options: ['Family with Young Kids', 'Family with Teenagers', 'Couple Without Kids', 'Senior Citizens'], defaultValue: 'Family with Young Kids' }
    ],
    generateRelevantExperience: (bg) => `Resident in a ${(bg.familyProfile || 'Family with Kids').toLowerCase()} using society children play facilities.`,
    followUpQuestions: [
      {
        id: 'cs_mq_1',
      ...
      },
      {
        ...
        inputType: 'rating',
        options: makeRatingOptions('Child Safety & Play Area Maintenance')
      }
    ]
  },
  ...
  // 21. Pet Rules
  {
    ...
    generateRelevantExperience: (bg) => `${(bg.residentType || 'Owner').toLowerCase()} observing society pet living guidelines and community environment.`,
    followUpQuestions: [
      {
        id: 'pr_mq_1',
      ...
      },
      {
        ...
        inputType: 'rating',
        options: makeRatingOptions('Pet Friendliness & Community Harmony')
      }
    ]
  },
  ...
  // 22. Insider Truths
  {
    ...
    generateRelevantExperience: (bg) => `${bg.yearsLiving || '5+ years'} ${(bg.residentType || 'Owner').toLowerCase()} sharing retrospective unvarnished living experience.`,
    followUpQuestions: [
      {
        id: 'it_mq_1',
      ...
      },
      {
        ...
        inputType: 'rating',
        options: makeRatingOptions('Overall Recommendation Score')
      }
    ]
  }
];

// Validate every topic's options for word count strict adherence!
topics.forEach((t) => {
  t.followUpQuestions.forEach((q) => {
    assertOptions(q.options, `${t.topicId} -> ${q.id}`);
  });
});

console.log('ALL 22 TOPICS PASSED 45-100 WORD COUNT VALIDATION SUCCESSFULLY!');

// Generate STRUCTURED_QUESTIONS_DATABASE from topics
const structuredQuestionsMap = {};
topics.forEach((t) => {
  structuredQuestionsMap[t.topicId] = t.followUpQuestions.map((fq) => ({
    id: fq.id,
    topicId: t.topicId,
    questionText: fq.questionText,
    type: fq.inputType === 'rating' ? 'rating' : 'single-choice',
    inputType: fq.inputType,
    options: fq.options,
    helpText: fq.helpText
  }));
});

// Construct TypeScript File Content
const fileHeader = `import { ContributorQuestion } from '../types';
...
const catalogItems = topics.map(t => {
  const tObj = { ...t };
  delete tObj.generateRelevantExperience;
  const json = JSON.stringify(tObj, null, 2);
  // Insert generateRelevantExperience and generateRelevantExperienceLabels before closing brace
  const fnCode = `  generateRelevantExperience: (bg: Record<string, string>) => \`\${bg.yearsLiving || '5+ years'} \${(bg.residentType || 'Owner').toLowerCase()} sharing retrospective unvarnished living experience.\`,\n  generateRelevantExperienceLabels`;
  return json.slice(0, json.lastIndexOf('}')).trimEnd() + ',\n' + fnCode + '\n}';
});

const fixedCatalogCode = `export const MAIN_QUESTIONS_CATALOG: MainQuestionItem[] = [\n` + catalogItems.join(',\n') + `\n];\n`;

const databaseCode = `export const STRUCTURED_QUESTIONS_DATABASE: Record<string, StructuredSubQuestion[]> = ${JSON.stringify(structuredQuestionsMap, null, 2)};\n`;
...
const fullTsFileContent = fileHeader + '\n' + fixedCatalogCode + '\n' + databaseCode + '\n' + footerCode;

fs.writeFileSync(path.join(__dirname, 'src/data/contributorTopicsData.ts'), fullTsFileContent, 'utf8');
console.log('Successfully wrote src/data/contributorTopicsData.ts!');
