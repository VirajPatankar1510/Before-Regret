...
import { MessageSquare, CheckCircle, Clock, Wallet as WalletIcon, Coins, Award, LogOut, FileText, Bookmark, Settings, Check, User, ArrowUpRight, HelpCircle, AlertCircle, Sparkles, Compass } from 'lucide-react';
        ...
        <div className="flex items-center gap-3.5">
          ...
          <div>
            ...
            <p className="text-xs text-slate-500 font-medium">
              {activeRole === 'buyer' 
                ? 'Check status of your escrow protected neighbor queries or message residents.' 
          ...
          <div className="lg:col-span-3 space-y-6">
            ...
            {activeTab === 'questions' && (
              <div className="space-y-6">
                ...
                <div>
                  <h3 className="font-bold text-sm text-slate-400 uppercase tracking-wider mb-4">Active escrow consultations</h3>
                      ...
                      {activeQuestions.map((q) => (
                        <div key={q.id} className="bg-white border-2 border-slate-200 rounded-2xl p-5 sm:p-6 shadow-3xs flex flex-col justify-between gap-4">
                          ...
                          <div className="flex flex-wrap justify-between items-center gap-2 pt-2">
                            <span className="text-xs text-slate-400">Escrow Paid Amount: <strong className="font-mono text-slate-800">Rs. {q.pricePaid}</strong></span>
                            <div className="flex items-center gap-2">
                              {q.status === 'ACCEPTED' && (
                                <button
            ...
            {activeTab === 'invoices' && (
              <div className="bg-white border border-slate-200 rounded-2xl p-6">
                <h3 className="font-display font-black text-slate-900 text-base mb-4">Invoices & Escrow Receipts</h3>
                        ...
                        <div className="flex flex-wrap items-start justify-between gap-2 border-b border-slate-100 pb-3">
                          <div>
                            <span className="bg-emerald-50 text-emerald-700 text-[10px] font-bold px-2 py-0.5 border border-emerald-100 rounded-md">
                              ₹{q.pricePaid} ESCROW HELD ACTIVE
                            </span>
                            <h4 className="font-bold text-slate-900 text-sm mt-2">
            ...
            {expertTab === 'earnings' && (
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
                  ...
                  <div className="bg-white border border-slate-200 rounded-2xl p-5">
                    <span className="text-[10px] font-bold text-slate-400 uppercase tracking-wider font-mono">Held in Escrow</span>
