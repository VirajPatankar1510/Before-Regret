...
export function App() {
  ...
  useEffect(() => {
    ...
    if (currentStep === 'HOME' && pseoRoute.type === 'none' && window.location.pathname === '/') {
      applyHeadSeo({
        ...
        title: 'Before Regret — Free US Property Research',
        description: 'Before Regret is free property research for US home buyers: the questions to ask the seller and what to inspect first, for any US home.',
  ...
  return (
    <div className="min-h-screen bg-white font-sans text-slate-900 flex flex-col relative">
      <Navbar
