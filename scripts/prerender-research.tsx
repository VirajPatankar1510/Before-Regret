...
<head>
  ...
  <meta name="description" content="Five original analyses of US public housing-risk data: insurance pricing against modelled risk, flood insurance take-up, flood claims paid outside the mapped zone, the condition and emergency planning status of high-hazard dams, and storm frequency against what households actually pay to insure. Every figure downloadable, every method published.">
  <meta name="robots" content="index, follow, max-image-preview:large, max-snippet:-1">
