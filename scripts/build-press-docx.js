...
const SOURCES = [
  ...
  { txt: 'docs/press-north-texas-roof-age.txt', docx: 'docs/press-north-texas-roof-age.docx' },
  { txt: 'docs/press-raise-or-remove.txt', docx: 'docs/press-raise-or-remove.docx' },
];
