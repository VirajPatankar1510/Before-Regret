...
<div class="wrap">
  <p class="kicker">Regional analysis &middot; Collin and Denton counties, Texas</p>
  <h1>Built together, due together</h1>
  <p class="standfirst">Half the houses in two North Texas counties went up inside the same twenty
  years, in one of the country's heaviest hail corridors. Roofs do not age one house at a time
  here &mdash; they age in a cohort, and the cohort comes due together.</p>
...
${controlRows}
  ...
  cost to actual cash value, raise the wind and hail deductible, or decline the risk.</p>
